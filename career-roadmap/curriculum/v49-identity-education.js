...
function updateIdentityDataV49(){
 ...
 r.versions=[{name:'2026年7月 Identity & Education Correction',date:'2026-07-14',target:'SoC / 数字IC验证方向',changes:'姓名统一为Zhantong；硕士专业依据正式学位证改为Electronic Design（电子设计）；移除民华微电子FPGA验证经历。'},...arr(r.versions).filter(x=>x.name!=='2026年7月 Identity & Education Correction')];
